...
@section('contentContainer')
 ...
 <div class="portlet">
        ...
        <div class="portlet-content">
          ...
          {{ Form::open(array('route'=>'admin.classes.store','class'=>'form-horizontal','role'=>'form','method'=>'post')) }}
