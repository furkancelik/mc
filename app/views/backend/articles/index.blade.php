...
@section('contentHeader')
      <div class="content-header">
        <h2 class="content-header-title">Kayıtlı Makaleler</h2>
        <ol class="breadcrumb">
          ...
          <div class="portlet">
            ...
            <div class="portlet-header">
              ...
              <h3>
				...
				<a href="{{ URL::route('admin.article.create') }}" class="btn btn-primary btn-sm" style="float:right;margin:5px;">Yeni Ekle</a>
            </div> <!-- /.portlet-header -->
            ...
            <div class="portlet-content">           
              ...
              <table 
                ...
                data-info="true">
                  <thead>
                    <tr>
                      <th data-filterable="true">Makale Başlığı</th>
                  ...
                  @foreach($veriler as $veri)
				   <tr >
						...
						<td class="hidden-xs hidden-sm">
							{{ Form::open(array('method'=>'delete','route'=>array('admin.article.destroy',$veri->id))); }}
							<a style="margin:5px;" title="Düzenle" href="{{ URL::route('admin.article.show',$veri->id) }}"><i class="fa fa-pencil-square-o"></i></a>
