...
@section('contentContainer')
 ...
 <div class="portlet">
		...
		@endforeach
          ...
          {{ Form::open(array('class'=>'form-horizontal','role'=>'form','method'=>'put','route'=>array('admin.article.update',$veriler['en']->id))) }}
		...
		@endforeach
			...
			<input type="hidden" name="key" value="{{ Article::orderBy('id','DESC')->first()->id+1 }}" />
			{{ Form::close() }}
